    ...
    return (
      <>
        ...
        >
          {isAuthenticated() ? (
            [
              <MenuItem key="create" onClick={() => { handleNavigation('/create'); handleClose(); }}>
                <CreateIcon sx={{ mr: 1 }} />
                글쓰기
              </MenuItem>,
              <MenuItem key="profile" onClick={() => { handleNavigation('/profile'); handleClose(); }}>
                <PersonIcon sx={{ mr: 1 }} />
                내 정보
              </MenuItem>,
            ...
            [
              <MenuItem key="login" onClick={() => { handleNavigation('/login'); handleClose(); }}>
                <LoginIcon sx={{ mr: 1 }} />
                로그인
              </MenuItem>,
              <MenuItem key="register" onClick={() => { handleNavigation('/register'); handleClose(); }}>
